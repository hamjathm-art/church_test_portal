        ...
        {view === 'certificate' && certificateRecord ? (
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="baptism-bottom-btns" style={{
              ...
              {editingId && (
                <ActionButton variant="secondary" type="button" onClick={handleCancel}>Cancel</ActionButton>
              )}
          ...
          <div className="baptism-search-section" style={{ padding: '24px 28px' }}>
            ...
            <div className="baptism-search-btns" style={{
              ...
              <SearchButton onClick={() => handleSearch()} disabled={searchLoading}>{searchLoading ? 'Searching...' : 'Search Baptism'}</SearchButton>
            </div>
